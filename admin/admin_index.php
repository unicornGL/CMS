...
$select_all_comments = mysqli_query($link, $query);
...
$select_all_users = mysqli_query($link, $query);
...
$select_all_categories = mysqli_query($link, $query);
...
$select_all_published_post = mysqli_query($link, $query);
...
$select_all_unapproved_comment = mysqli_query($link, $query);
$unapproved_comment_count = mysqli_num_rows($select_all_unapproved_comment);

$query = "SELECT * FROM users WHERE user_role = 'subscriber'";
$select_all_subscriber = mysqli_query($link, $query);
