...
if (isset($_GET['admin_edit_user'])) {
  $the_user_id = $_GET['admin_edit_user'];

  $query = "SELECT * FROM users WHERE user_id = $the_user_id";
  $select_users_query = mysqli_query($link, $query) or die ("QUERY FAILED" . mysqli_error($link));
  ...
  if (isset($_POST['edit_user'])) {
    ...
    $edit_user_query = mysqli_query($link, $query) or die ("QUERY FAILED" . mysqli_error($link));
