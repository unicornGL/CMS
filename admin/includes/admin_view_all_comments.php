...
echo "<td><a href='admin_comments.php?delete=$comment_id'>X</a></td>";
echo "</tr>";
}
?>
...
if(isset($_GET['approve'])) {
  ...
  $approve_comment_query = mysqli_query($link, $query) or die("QUERY FAILED" . mysqli_error($link));
...
if(isset($_GET['unapprove'])) {
  ...
  $unapprove_comment_query = mysqli_query($link, $query) or die("QUERY FAILED" . mysqli_error($link));
  header("Location: admin_comments.php");
}
